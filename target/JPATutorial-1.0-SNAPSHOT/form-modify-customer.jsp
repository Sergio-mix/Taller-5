...
<!--Form-->
<div class="content">
    <h1 class="logo">Modify <span> Client</span></h1>
    <div class="contact-wrapper animated bounceInUp">
        <div class="contact-form">
            ...
            <form action="./modify-customer">
                ...
                <p>
                    <label>Gender</label>
                    <select class="select-item" id="txt_gender" name="gender"
                            required>
                ...
                <p>
                    <label>Email</label>
                    <input type="email" id="txt_email" name="email" value="<%= request.getParameter("email") %>"
                           required>
                </p>
                <div class="block">
